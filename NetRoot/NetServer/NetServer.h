...
namespace server_baby
{
    ...
    protected:
        ...
        virtual void OnClientJoin(const NetSessionID NetSessionID) {}; //Accept 후 접속 처리 완료 후 호출.
        virtual void OnClientLeave(const NetSessionID NetSessionID) {}; //Release 후 호출
